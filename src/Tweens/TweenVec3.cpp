...
TweenVec3::TweenVec3(ofVec3f * a_property, ofVec3f  a_begin, ofVec3f  a_end, int a_delay, int a_duration, int a_easeType, float a_p, float a_a) {
    _useSeconds = false;
    _time		= 0.f;
...
TweenVec3::TweenVec3(ofVec3f * a_property, int a_millis, ofVec3f  a_begin, ofVec3f  a_end, float a_delay, float a_duration, int a_easeType, float a_p, float a_a) {
    _useSeconds = true;
...
//--------------------------------------------------------------
void TweenVec3::_setup(ofVec3f * a_property, ofVec3f a_begin, ofVec3f a_end, float a_delay, float a_duration, int a_easeType, float a_p, float a_a) {
    _tweenType = VEC3;
