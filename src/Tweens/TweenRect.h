...
public:
    ...
    TweenRect(ofRectangle * a_property, ofRectangle a_begin, ofRectangle a_end, int a_delay, int a_duration, int a_easeType, float a_p=0, float a_a=0);
    TweenRect(ofRectangle * a_property, int a_millis, ofRectangle a_begin, ofRectangle a_end, float a_delay, float a_duration, int a_easeType, float a_p=0, float a_a=0);
...
protected:
    void _setup(ofRectangle * a_property, ofRectangle a_begin, ofRectangle a_end, float a_delay, float a_duration, int a_easeType, float a_p, float a_a);
