...
TweenVec4::TweenVec4(ofVec4f * a_property, ofVec4f  a_begin, ofVec4f  a_end, int a_delay, int a_duration, int a_easeType, float a_p, float a_a) {
    _useSeconds = false;
    _time		= 0.f;
...
TweenVec4::TweenVec4(ofVec4f * a_property, int a_millis, ofVec4f  a_begin, ofVec4f  a_end, float a_delay, float a_duration, int a_easeType, float a_p, float a_a) {
    _useSeconds = true;
